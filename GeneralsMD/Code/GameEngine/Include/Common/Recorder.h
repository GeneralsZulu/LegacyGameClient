...
public:
	...
	enum ReplayEpoch
	{
		...
		REPLAY_EPOCH_V153   = 4, ///< 1.5.3+: upgrade commands carry the stable upgrade id (mask bit), not a raw namekey
		REPLAY_EPOCH_CURRENT = REPLAY_EPOCH_V153
	};
	...
	// Pre-V153 replays recorded upgrade purchases as raw NameKeyType values.
	...
	// staleRefs regression). During playback of a pre-V153 replay this returns
